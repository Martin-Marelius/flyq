...
function HomePage() {
  ...
  function searchAirport() {
    return (
      <div>
        <button className="flex peer hover:peer focus:peer active:scale-105 transition-all">
        ...
        <div className={`z-50 peer-active:flex active:flex peer-focus:flex hover:flex hidden absolute flex-col mt-2 rounded-xl shadow-lg p-2 bg-slate-800 place-content-center`}>
          {allVenues.map((ven) => (
